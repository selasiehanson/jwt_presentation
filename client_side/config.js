...
System.config({
  "map": {
    ...
    "angular-bootstrap-switch": "bower:angular-bootstrap-switch@0.3.0",
    ...
    "angular-ui-select2": "bower:angular-ui-select2@0.0.5",
    "faker": "npm:faker@2.1.2",
    "font-awesome": "bower:font-awesome@4.3.0",
    "jquery": "github:components/jquery@2.1.3",
    "name": "bower:angularLocalStorage@0.3.0",
    ...
    "bower:angular-bootstrap-switch@0.3.0": {
      "angular": "bower:angular@1.2.28",
      "bootstrap": "bower:bootstrap@3.3.4",
      "bootstrap-switch": "bower:bootstrap-switch@3.0.2",
      "jquery": "bower:jquery@2.1.3"
    },
    "bower:angular-cookies@1.3.15": {
    ...
    "bower:angular-ui-select2@0.0.5": {
      "angular": "bower:angular@1.3.15",
      "jquery": "bower:jquery@2.1.3",
      "select2": "bower:select2@3.4.8"
    },
    "bower:angularLocalStorage@0.3.0": {
      "angular": "bower:angular@1.3.15",
      "angular-cookies": "bower:angular-cookies@1.3.15"
    },
    "bower:bootstrap-switch@3.0.2": {
      "css": "github:systemjs/plugin-css@0.1.6",
      "jquery": "bower:jquery@2.1.3"
    },
